...
class AppColors {
  ...
  static final Color? backgroundColor = Colors.amber[100];
  static final Color? primaryColor = Colors.grey[200];
  static final Color? secondaryColor = Colors.white;
  static final Color? inversePrimaryColor = Colors.grey[700];
